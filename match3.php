...
$query_INFO="SELECT * FROM MATCHES WHERE MATCH_ID=102";
...
$query_VENUE="SELECT * FROM VENUE WHERE MATCH_ID=102";
...
$query_NAME1="SELECT * FROM MATCHES WHERE MATCH_ID=102";
...
$query_TEAM1="SELECT * FROM BATSMEN WHERE T_ID IN (SELECT T_ID FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN (SELECT BAT_FIRST FROM MATCHES WHERE MATCH_ID=102));";
...
$query_NAME2="SELECT * FROM MATCHES WHERE MATCH_ID=102";
...
$query_TEAM2="SELECT * FROM BATSMEN WHERE T_ID IN (SELECT T_ID FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN (SELECT BAT_SECOND FROM MATCHES WHERE MATCH_ID=102));";
...
$query_TOTAL_INFO1="SELECT * FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN(SELECT BAT_FIRST FROM MATCHES WHERE MATCH_ID=102);";
...
$query_TOTAL_INFO2="SELECT * FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN(SELECT BAT_SECOND FROM MATCHES WHERE MATCH_ID=102);";
...
$query_TOTAL_SCORE1="SELECT * FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN(SELECT BAT_FIRST FROM MATCHES WHERE MATCH_ID=102);";
...
$query_TOTAL_SCORE2="SELECT * FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN(SELECT BAT_SECOND FROM MATCHES WHERE MATCH_ID=102);";
...
<?php
$query_BAT_FIRST ="SELECT * FROM BATSMEN WHERE T_ID IN (SELECT T_ID FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN (SELECT BAT_FIRST FROM MATCHES WHERE MATCH_ID=102));";
...
<?php
$query_BALL_FIRST="SELECT * FROM BOWLERS WHERE T_ID IN (SELECT T_ID FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN (SELECT BAT_SECOND FROM MATCHES WHERE MATCH_ID=102));";
...
<?php
$query_BAT_SECOND ="SELECT * FROM BATSMEN WHERE T_ID IN (SELECT T_ID FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN (SELECT BAT_SECOND FROM MATCHES WHERE MATCH_ID=102));";
...
<?php
$query_BALL_SECOND="SELECT * FROM BOWLERS WHERE T_ID IN (SELECT T_ID FROM TEAMS WHERE MATCH_ID=102 AND T_NAME IN (SELECT BAT_FIRST FROM MATCHES WHERE MATCH_ID=102));";
...
<body>
  <div class="main">
    ...
    <div class="container top">
      <h2>Australia vs India, 3rd T20I - Cricket Score</h2>
    </div>
